...
\begin{figure}[!h] % !t
\center
\subfigure[$y$ in function of $55^{th}$ dimension of $X$.]{\includegraphics[width=2in]{figures/dim6.png} \label{fig:reg_dim6}}
\hfill
\subfigure[$y$ in function of $6^{th}$ dimension of $X$.]{\includegraphics[width=2in]{figures/dim55.png} \label{fig:reg_dim55}}
...
\begin{figure}[!h] % !t
	\center
	\subfigure[Histogram of the $23^{th}$ dimension of $X$.]{\includegraphics[width=2.1in]{figures/dim23.png} \label{fig:class_dim23}}
	\hfill
	\subfigure[Histogram of the $35^{th}$ dimension of $X$.]{\includegraphics[width=2.1in]{figures/dim35.png} \label{fig:class_dim35}}
